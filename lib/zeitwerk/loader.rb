...
module Zeitwerk
  class Loader
    ...
    # at the end of eager loading. They are useless there and that way we save
    # some memory.
    #
    ...
    # There is no interface to undo this, either you want to reload or you
    # don't, can't change your mind.
    #
    # @raise [Zeitwerk::Error]
    # @return [void]
